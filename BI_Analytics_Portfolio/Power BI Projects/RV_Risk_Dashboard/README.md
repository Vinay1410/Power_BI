...
A Power BI dashboard showcasing Residual Value (RV) risk monitoring using Python-generated lease return data — focused on gain/loss performance, risk drivers, and regional volatility.
...
## 4️⃣ **Regional Risk & Market Volatility**
...
## 1) Generate dataset
Run the script in Visual Studio Code: Generate_RV_Data.py